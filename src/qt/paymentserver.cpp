...
const QString BITCOIN_IPC_PREFIX("CloudStorageIntegral:");
...
{
    QString name("CloudStorageIntegralQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click CloudStorageIntegral: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start CloudStorageIntegral: click-to-pay handler");
    else
...
{
    // clicking on CloudStorageIntegral: URLs creates FileOpen events on the Mac:
