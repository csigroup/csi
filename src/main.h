...
static const int64_t MAX_MONEY = 120000000 * COIN; //newtodo1
...
public:
    ...
    {
        // CloudStorageIntegral: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // CloudStorageIntegral: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // CloudStorageIntegral: two types of block: proof-of-work or proof-of-stake
    ...
    // CloudStorageIntegral: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // CloudStorageIntegral: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // CloudStorageIntegral: block index flags
    enum  
    {
