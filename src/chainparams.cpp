...
public:
    CMainParams() {
        ...
        pchMessageStart[0] = 0xb2; //newtodo1 其中 0x 保持不变,数字范围 0-6,字母范围 a-f
        pchMessageStart[1] = 0x22;
        pchMessageStart[2] = 0xc3;
        pchMessageStart[3] = 0x41;
        vAlertPubKey = ParseHex("0486bce1bac0d543f104cbff2bd23680056a3b9ea05e1137d2ff90eeb5e08472eb500322593a2cb06fbf8297d7beb6cd30cb90f98153b5b7cce1493749e41e0284");
        nDefaultPort = 22883; //newtodo1
        nRPCPort = 22885;
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        unsigned int nGenesisTime = 1463673600;
...
#endif
        assert(hashGenesisBlock == uint256("0000b33651092e46e5b09e3756ff7f2716238a09d334698ce25c651f7d3cc3b4"));
        assert(genesis.hashMerkleRoot == uint256("c1e4d3212914d80de32dae3bf1d08e1e76247484d27e7aa06d514a1c857c9dd1"));

        //add dnsseed newtodo1
        char *seeds[][2] ={
            "114.55.136.135","114.55.136.135",
            "47.88.190.1","47.88.190.1",
            "47.88.192.52","47.88.192.52",
            "139.196.197.179","139.196.197.179",
            "115.28.66.73","115.28.66.73",
            "123.56.66.46","123.56.66.46"
                          };
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of(28); //newtodo1 http://cryptolife.net/upwg/
